...
```bash
./packaging/linux/build-appimage.sh 2.0.2      # AppImage + tarball
./packaging/linux/build-rpm.sh 2.0.2           # Fedora/RHEL RPM
./packaging/macos/build-dmg.sh 2.0.2           # macOS
# Windows (MSYS2): ./packaging/windows/build-installer.sh 2.0.2
```
